...
| 13.08.2018 |Вызов методов классов по запросу (call_user_func).  |**done**
| 16.08.2018 |Сохранение контекста диалога (context).  |**done**
| ---- |Сохранение профиля пользователя.  |**in plan**
| ---- |Авторизация пользователя.  |**in plan**
